...
public class GoodsInImagesRequest implements Serializable {
    ...
    private List<GoodsInImagePath> Images;

    public GoodsInImagesRequest() {
    }

    public GoodsInImagesRequest(int goodsInId, int userId, String userCode, List<GoodsInImagePath> images) {
        GoodsInId = goodsInId;
        UserId = userId;
        UserCode = userCode;
        Images = images;
    ...
    @JsonProperty("Images")
    public List<GoodsInImagePath> getImages() {
        return Images;
    }

    public void setImages(List<GoodsInImagePath> images) {
        Images = images;
    }
}
