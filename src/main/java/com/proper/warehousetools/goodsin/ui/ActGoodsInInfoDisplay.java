 ...
 */
public class ActGoodsInInfoDisplay extends BaseActivity {
                ...
                if (img != null) {
                    if (!mPhotoPathUri.toString().isEmpty()) {
                        if (img != null) {
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(ActGoodsInInfoDisplay.this);
...
//                this.finish();
            ...
            case R.id.bnGoodsinInfoDisplayProvideInfo:
                //do provide info
                Intent provideIntent = new Intent(this, ActGoodsInProvideInfo.class);
...
//                        LogEntry log = new LogEntry(1L, ApplicationID, "ActGoodsInInfoDisplay - ButtonClicked", deviceIMEI, RuntimeException.class.getSimpleName(), iMsg, today);
//                        logger.log(log);
//                        img = null;
//                    }
//                } else {
...
//            }
    ...
    private class UploadPhotoAsync extends AsyncTask<GoodsInImage, Void, AbstractMap.SimpleEntry<Boolean, String>> {
        ...
        protected void onPreExecute() {
            ...
            xDialog = new ProgressDialog(ActGoodsInInfoDisplay.this);
        ...
        protected void onPostExecute(AbstractMap.SimpleEntry<Boolean, String> response) {
            ...
            if (response != null) {
                if (response.getKey() == true) {
                    ...
                    ActGoodsInInfoDisplay.this.finish();
                } else {
                    String mMsg = "Unable to upload a Goods-In Image over the network.\nPlease contact IT if error continues";
                    AlertDialog.Builder builder = new AlertDialog.Builder(ActGoodsInInfoDisplay.this);
                    builder.setMessage(mMsg)
